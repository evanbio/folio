...
读 single-cell 文献时，cell annotation 经常是一句“we annotated clusters using markers/reference”就带过，但它实际决定了后续几乎所有生物学解释。刚好需要给 `concept/single-cell/cell-annotation.qmd` 建一个基础概念入口，所以先读这篇相对早期但结构清楚的综述。
...
完整阅读笔记见 [literature workspace](../literature/papers/pasquiniAutomatedMethodsCell2021/index.qmd)，概念整理见 [Cell Annotation](../concept/single-cell/cell-annotation.qmd)。
